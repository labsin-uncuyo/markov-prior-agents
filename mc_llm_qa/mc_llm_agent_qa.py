"""
This module implements an agent that is using MC LLM as a planning agent
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--markov_chain",
        type=str,
        default=os.path.join(os.path.dirname(__file__), "transition_probabilities.json"), # Default file path relative to script
